                ...
                <form action="{{ $isEdit ? route('pricing.update', $history->id) : route('pricing.calculate') }}" method="POST">
                    ...
                    <div class="mb-8">
                        <h6 class="text-sm font-extrabold text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-4 flex items-center">
                            <i class="fas fa-sliders-h mr-2"></i> 4. Variabel Adjustment & Parameter (Dapat Diubah)
                        </h6>
                    ...
                    <div class="mb-10">
                        <h6 class="text-sm font-extrabold text-green-600 dark:text-green-400 uppercase tracking-wider mb-4 flex items-center">
                            <i class="fas fa-magic mr-2"></i> 5. Recommendation Selling Price (Auto)
                        </h6>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculatePricing() {
                ...
                // 🔥 TARIK DATA DARI KOTAK BARU YANG BISA DIEDIT BOS LU 🔥
                ...
                // ====================================================================
                // 🔥 LOGIKA ADJUSTMENT SEKARANG DINAMIS (SINKRON DENGAN EXCEL & PHP) 🔥
                // ====================================================================
                let adjustment = 0;
                ...
                // 2. Rule Demand (Tinggi = Harga Naik, Rendah = Harga Turun / Minus)
                if (demand === 'tinggi') {
                    adjustment += (ruleDemandTinggi / 100); 
                } else if (demand === 'rendah') {
                    adjustment -= (ruleDemandTinggi / 100); // 🔥 INI TAMBAHANNYA (BIAR MINUS) 🔥
                }
                ...
                // 🔥 PERBAIKAN LOGIKA KOMPETITOR (JANGAN RATA-RATA KALAU KOSONG) 🔥
                ...
                if(comps.length > 0) {
                    ...
                    tempPrice = adjustedPrice; // Monopoli! Nggak ada saingan
                }
            ...
            // Kalau ganti produk, Update kotak Buffer & Threshold dari Database otomatis!
            ...
            // Daftarkan semua input baru biar Real-time kalau diubah!
            const inputs = [
