...
Route::middleware(['auth', 'role:administrator,manager'])->group(function () {
    ...
    // Modul Restock Gudang
    Route::get('/restock-gudang', [RestockController::class, 'index'])->name('restock.index');
    Route::post('/restock-gudang/process', [RestockController::class, 'processReorder'])->name('restock.process');
    Route::delete('/restock-gudang/delete/{id}', [RestockController::class, 'destroyPlan'])->name('restock.destroyPlan');
    Route::get('/restock-gudang/print', [RestockController::class, 'printPDF'])->name('restock.print');
    Route::put('/restock-gudang/update/{id}', [RestockController::class, 'updatePlan'])->name('restock.updatePlan');
    Route::post('/restock-gudang/auto', [RestockController::class, 'autoRestock'])->name('restock.auto');
    ...
    Route::put('/suppliers/products/{id}/contract', [SupplierController::class, 'updateProductContract']);
    ...
    Route::get('/document-center/{type}', [DocumentCenterController::class, 'index'])->name('document.center');
...
Route::middleware(['auth', 'role:administrator'])->group(function () {
    ...
    Route::get('/pricing-type/{type}', [PricingTypeController::class, 'index'])->name('pricing.type');
